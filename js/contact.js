    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success == 0) {
                ...
                $("div#output_success").removeClass('alert-error').addClass('alert-success').show().html('<button type="button" class="close" data-dismiss="alert">x</button><p>Your message has been sent successfully!</p>');
            }
